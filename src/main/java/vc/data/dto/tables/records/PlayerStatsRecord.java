...
public class PlayerStatsRecord extends TableRecordImpl<PlayerStatsRecord> implements Record8<Long, Long, Long, Long, OffsetDateTime, OffsetDateTime, Integer, Integer> {
    ...
    @Override
    public Row8<Long, Long, Long, Long, OffsetDateTime, OffsetDateTime, Integer, Integer> valuesRow() {
    ...
    @Override
    public PlayerStatsRecord values(Long value1, Long value2, Long value3, Long value4, OffsetDateTime value5, OffsetDateTime value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PlayerStatsRecord(Long joinCount, Long leaveCount, Long deathCount, Long killCount, OffsetDateTime firstSeen, OffsetDateTime lastSeen, Integer playtime, Integer playtime_30Days) {
        super(PlayerStats.PLAYER_STATS);
