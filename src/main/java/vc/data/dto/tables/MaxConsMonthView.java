...
public class MaxConsMonthView extends TableImpl<MaxConsMonthViewRecord> {
    ...
    public MaxConsMonthView where(Condition condition) {
        return new MaxConsMonthView(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public MaxConsMonthView whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public MaxConsMonthView whereNotExists(TableLike<?> select) {
