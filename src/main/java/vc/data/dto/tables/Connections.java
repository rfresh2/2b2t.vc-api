...
public class Connections extends TableImpl<ConnectionsRecord> {
     ...
     */
    public final TableField<ConnectionsRecord, Connectiontype> CONNECTION = createField(DSL.name("connection"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(vc.data.dto.enums.Connectiontype.class), this, "");
