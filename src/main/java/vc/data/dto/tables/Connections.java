...
public class Connections extends TableImpl<ConnectionsRecord> {
    ...
    public Connections where(Condition condition) {
        return new Connections(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Connections whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Connections whereNotExists(TableLike<?> select) {
