...
public class TopDeathsMonthView extends TableImpl<TopDeathsMonthViewRecord> {
    ...
    public TopDeathsMonthView where(Condition condition) {
        return new TopDeathsMonthView(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public TopDeathsMonthView whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public TopDeathsMonthView whereNotExists(TableLike<?> select) {
